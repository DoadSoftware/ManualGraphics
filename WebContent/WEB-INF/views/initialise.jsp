...
<head>
	...
	.logo {
	    width: 230px; /* Increased Logo Size */
	    margin-bottom: 20px;
	}
	...
	.form-control {
	    ...
	    font-size: 18px; /* Increased input field text size */
	}
	...
	.btn-submit {
	    ...
	    color: white;
	    font-size: 19px; /* Increased button text size */
	    font-weight: bold;
	    padding: 14px;
	    border-radius: 6px;
	    border: none;
	...
	.footer {
	    margin-top: 15px;
	    font-size: 16px; /* Increased footer text size */
	    color: #555;
	}
...
<div class="container-box">
    ...
    <!-- Footer -->
    <div class="footer">
        <p>Need help? <a href="<c:url value='/contact' />" style="color: #2563EB; text-decoration: underline;">Contact Support</a></p>
    </div>
